      ...
      <div className="container">
        <div className="about-card">
          ...
          <div className="about-content">
            ...
            <p className="about-description">
              Notre mission est de valoriser le cinéma local, soutenir les talents émergents et offrir
              une plateforme aux cinéastes togolais.
            </p>
            <p className="about-description">
              Rejoignez-nous pour célébrer le cinéma et découvrir les histoires uniques du Togo
              à travers notre passion commune.
            </p>
          </div>
          ...
          <div className="about-location">
            ...
            <div className="location-content">
              ...
              <p><strong>Email :</strong> <a href="mailto:grct228@gmail.com">grct228@gmail.com</a></p>
